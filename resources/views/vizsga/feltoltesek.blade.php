            ...
            <div class="table-responsive">
                <table class="table table-hover">
                    ...
                    <tbody>
                        ...
                        <tr data-id="{{ $show->id }}">
                            <td>
                                <input type="checkbox" class="form-check-input show-select" value="{{ $show->id }}">
                            </td>
                            <td>
                                <img src="{{ asset('uploads/vizsga/' . $show->image_url) }}" alt="{{ $show->title }}" 
                                     style="height: 50px; width: 50px; object-fit: cover;" class="rounded">
                            </td>
                            <td>{{ $show->title }}</td>
                            <td>{{ $show->category }}</td>
                            <td>{{ ucfirst($show->type) }}</td>
                            <td>
                                <button class="btn btn-primary btn-sm edit-show" data-show="{{ json_encode($show) }}">
                                    Szerkesztés
                                </button>
                            </td>
                        </tr>
